                   ...
                   <h2>Insert New Course</h2>
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" method="post">
                        ...
                        <p>
                            ...
                            <input type="file" value="Post Featured Image" name="post_featured_image">
                        </p>
                        <p>
                        ...
                        <p>
                            <center><label for="post_author">Course Author  "<strong><?php echo $_SESSION['user_name'];?></strong>"</label></center>
...
$post_date = date('d-m-y');  
    if($post_title == '' OR $post_content == '' OR $post_featured_image == '' OR $post_categories == '' OR $post_keywords == '' OR $post_author == ''){
    echo "<script>alert('Please Fill All The Fields')</script>";
        exit();
    }
    else{
    move_uploaded_file($post_featured_image_tmp,"images/$post_featured_image");
    $insert_post = "insert into posts (cat_id,post_title,post_date,post_author,post_keywords	,post_image,post_content) values ('$post_categories','$post_title','$post_date','$post_author','$post_keywords','$post_featured_image','$post_content')";
