...
$post_date = date('d-m-y');  
    ...
    $update_post = "UPDATE posts SET cat_id='".$post_categories."',post_title='".$post_title."',post_date='".$post_date."',post_author='".$post_author."',post_keywords='".$post_keywords."',post_content='".$post_content."' WHERE post_id='".$post_id."'"; 
